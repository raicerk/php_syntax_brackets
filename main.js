...
define(function (require, exports, module) {
    ...
    var AppInit = brackets.getModule('utils/AppInit'),
        phpsyntex = require('text!php-syntax.txt');
    ...
    function WordHints() {
        ...
        this.cachedMatches = [];
        this.cachedWordList = [];
        this.tokenDefinition = /[a-zA-Z][A-Za-z0-9!@#$%^&*()-_:;"' .{}]{2,}/g;
        this.currentTokenDefinition = /[a-zA-Z][A-Za-z0-9!@#$%^&*()-_:;"' .{}]+$/g;
    }
    ...
    WordHints.prototype.hasHints = function (editor, implicitChar) {
        ...
        if(cursor.line != this.lastLine){
            var rawWordList = phpsyntex.match(this.tokenDefinition);
            this.cachedWordList = [];
